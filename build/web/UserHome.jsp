...
<html>
    ...
    <body>
        ...
        <div class="container-fluid containers">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent" >
                    ...
                    <ul class="navbar-nav " style="margin-left: auto!important" >
                        ...
                        <li class="nav-item mr-5">
                            <a class="nav-link navtext" href="ConductSurvey.jsp" >Conduct Survey</a>
                        </li>
                        ...
                        <li class="nav-item dropdown mr-4 navtext">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a   class="dropdown-item" href="SearchBloodCamp.jsp?value=all">Search blood camp for Donate Blood</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="FindBloodBankByCity.jsp?value=all">Find Blood-Banks</a>
                        ...
                        <li class="nav-item mr-5">
                            <!--                            <a data-toggle="modal" data-target="#doc" class="nav-link navtext" href="FindDoctorByTheirType.jsp?value=all" >Find Doctor</a>-->
                            <a class="nav-link navtext" href="FindDoctorByTheirType.jsp?value=all" >Find Doctor</a>
                        </li>
                        ...
                        <div class="modal-body">
                            ...
                            <form action="SearchDoctorServlet" method="POST">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="Doctor">
            ...
            <footer style="height: 300px;background: #06a190;margin-top: -30px">
                <!--                <div class="row" >
