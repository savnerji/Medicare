                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form action="searchCampByCityServlet" method="POST">
                ...
                <div class="col-md-8">
                    ...
                    <div class="card-columns">
                        ...
                        <%   String value = request.getParameter("value");
                            List<Organizecamp> list = null;
                            Bloodbankdao dao = new Bloodbankdao(ConnectionProvider.getConnection());
                            if (value.equals("all")) {
                                list = dao.getAllBloodCampOrganization();
                            } else {

                                list = dao.getAllBloodCampOrganizationByCity(value);
                                if (list.isEmpty()) {
                                ...
                                <table class="table text-center">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><%= l.getOrganizer() %></td>
                                            
                                        </tr>
                                        <tr>
                                            
                                            <td><strong>Blood Camp Address :</strong></td>
                                            <td><%=l.getCampAddress() %></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><%= l.getCampState() %></td>
                                            
                                        </tr>
                                        <tr>
                                            
                                            <td><strong>Camp instructions :</strong></td>
                                            <td><%= l.getCampDiscription() %></td>
                                            
                                        </tr>
                                        <tr>
                                            
                                            <td><strong>organized Date :</strong></td>
                                            <td><%= l.getConductDate() %></td>
                                            
                                        </tr>
                                        <tr>
                                            
                                            <td style="text-decoration: underline"><strong>Contact :</strong></td>
                                            <td><span>+91</span> <%= l.getCampContact()%></td>
