        ...
        <div class="container-fluid containers">
            ...
            <div class="row">
                ...
                <div class="col-lg-8  ">
                    ...
                    <img class="img-fluid img-thumbnail" src="images/blood-donation.jpg" style="height:950px;width: auto">
                ...
                <div class="col-lg-4 ">
                    ...
                    <div class="container  my-5 mt-5" style=";">
                        ...
                        <div class="card text-break" style="width: 30rem;">
                            ...
                            <div class="card-body">
                                <form action="BloodBankSignInServlet" method="POST">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Email address</label>
                                        <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="bank_email">
                                        <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Password</label>
                                        <input type="password" class="form-control" id="exampleInputPassword1" name="bank_password">
                                    </div>
